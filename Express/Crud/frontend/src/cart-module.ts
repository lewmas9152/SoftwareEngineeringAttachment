// cart-module.ts - Handles all shopping cart functionality
...
export class CartManager {
  ...
  public incrementCartItem(id: string): void {
  ...
  public decrementCartItem(id: string): void {
    const itemIndex = this.cartItems.findIndex(item => item.id === id);
    if (itemIndex !== -1) {
...
export function initCartModal(): void {
