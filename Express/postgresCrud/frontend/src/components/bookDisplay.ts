import { Book, BookStats } from '../models/types';
import cartManager from './cart';
import { BookModalManager } from './modal';

export class BookDisplay {
  private booksContainer: HTMLElement | null;
  private modalManager: BookModalManager;

  constructor(containerSelector: string = 'books-container') {
  ...
  updateStats(stats: BookStats): void {
